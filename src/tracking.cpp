...
SemiDenseTracking::SemiDenseTracking()
{
    ...
    boost::filesystem::remove_all((ros::package::getPath("surface_reconstruction")+"/src/map_and_poses").c_str());
    boost::filesystem::create_directory((ros::package::getPath("surface_reconstruction")+"/src/map_and_poses").c_str());
    boost::filesystem::remove_all((ros::package::getPath("surface_reconstruction")+"/src/evaluation").c_str());
    boost::filesystem::create_directory((ros::package::getPath("surface_reconstruction")+"/src/evaluation").c_str());
                     ...
                     ros::Publisher *odom_pub,ros::Publisher *pub_poses,ros::Publisher *vis_pub,cv::Mat &points3D_cam_to_print)
{
    ...
    {
        sprintf (buffer,(ros::package::getPath("surface_reconstruction")+"/src/map_and_poses/tracking.ply").c_str());
